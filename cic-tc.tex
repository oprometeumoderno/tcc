...
\section{Gerador de resultados}
\label{sec:barbell_results}
...
\begin{figure}[h!]
  \begin{center}
  \frame{\includegraphics[width=0.8\textwidth]{cartpolebarbell.png}}
...
% \begin{minted}[fontsize=\footnotesize]{python}
% \end{minted}
% \caption[Cópia de DNA]{caption}
% \label{label}
% \end{longlisting}
% LONGLISTING CODE EXAMPLE
...
\begin{figure}[h]
  \begin{center}
  \frame{\includegraphics[width=1\textwidth]{curva.png}}
...
\begin{figure}[h]
  \begin{center}
  \frame{\includegraphics[width=0.8\textwidth]{acrobot_gym.png}}
...
\begin{figure}[h]
  \begin{center}
  \frame{\includegraphics[width=0.8\textwidth]{acrobot_barbell.png}}
...
\begin{figure}[h]
  \begin{center}
  \frame{\includegraphics[width=0.8\textwidth]{flappy.jpeg}}
...
PARTS:
  ...
  floor:
      body_type: static
      body_shape: box
      initial_position: [600, -2]
      color1: white
      box_size: [600, 1]
  ceiling:
      body_type: static
      body_shape: box
      initial_position: [600, 1202]
      color1: white
      box_size: [600, 1]
  pipe1_top:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 150]
      initial_position: [1030, 350]
  pipe1_bottom:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30,50]
      initial_position: [1030, 50]
      z_index: 1
  pipe2_top:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 100]
      initial_position: [1030, 400]
  pipe2_bottom:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30,100]
      initial_position: [1030, 100]
      z_index: 1
  pipe3_top:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 50]
      initial_position: [1030, 450]
  pipe3_bottom:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 150]
      initial_position: [1030, 150]
  pipe4_bottom:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 200]
      initial_position: [1030, 200]
  pipe4_top:
      body_type: static
      body_shape: box
      color1: dark_olive_green
      box_size: [30, 2]
      initial_position: [1030, 498]
  pipe5_bottom:
     body_type: static
     body_shape: box
     color1: dark_olive_green
     box_size: [30, 2]
     initial_position: [1030, 0]
  pipe5_top:
     body_type: static
     body_shape: box
     color1: dark_olive_green
     box_size: [30, 200]
     initial_position: [1030, 300]
\end{minted}
\caption[Cópia de DNA]{Arquivo YAML que define o cenário do Flappy Bird}
\label{source:flappybird_yaml}
\end{longlisting}
...
desta lógica, os métodos \texttt{observation()}, \texttt{reward()} e \texttt{done()}
 ...
 \begin{figure}[h]
   \begin{center}
   \frame{\includegraphics[width=0.8\textwidth]{flappybird_barbell.png}}
   \caption{O jogo Flappy Bird}
...
% %
%
% % Foram realizados experimentos a fim de mostrar situações onde normalmente se
% % utilizaria simuladores de física para modelar o agente e o ambiente onde ele
% % atua. Os problemas abaixo foram escolhidos usando-se como critério a proximidade
% % de exemplos vistos
% %
% %
% % Foram realizados experimentos a fim de mostrar situações onde normalmente se
% % utilizaria um simulador de física para modelar o agente
% %
