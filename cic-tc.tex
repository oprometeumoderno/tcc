...
um problema custoso do ponto de vista computacional.
...
físicas de corpos articulados.

Este motor é ideal para simulações que possam
envolver veículos ou criaturas bípedes, por exemplo. Com uma extensa biblioteca
capas de gerar representações para os mais va

A \textit{Open Dynamics Engine} \cite{ODE} é uma ferramenta de simulações
...
tridimensionais, a ODE vem sendo mantida há mais de uma década, contando com uma
...
Na avaliação desenvolvida em \cite{LeggedRobotics}, a ODE se
...
o método utilizado pela ODE para o cálculo das forças resultantes \cite{LCP1971} é impreciso,
...
Lançado em 2006, o motor de física \textit{Bullet Physics} tinha como
