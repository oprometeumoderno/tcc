...
% simuladores
%   simuladores AR
%   arquitetura de um simulador??
%   ciclo de aprendizado?/?
%   como construir um simulador de AR do zero
%   motores de física
%   simuladores prontos
%   mujoco
%   gym
...
% algoritmos de aprendizado por reforço são recomendados em quaisquer situações
% onde ações devem ser tomadas de maneira sequencial por um agente inserido em
% ambiente. Um problema
...
% próxima jogada com base em sua composição; nos casos utilizados como exemplo no
% início deste capítulo, uma representação do mundo real precisa ser modelada,
% para que o comportamento diverso que cenários reais podem apresentar estejam
% sob o controle daqueles que treinam o agente.
%
%
%
% É preciso notar, portanto, que as aplicações de simuladores em aprendizado por
% reforço são vastas e vão muito além da imitação de ambientes encontrados no
% mundo real.??
% É preciso notar, portanto, que as aplicações de simuladores em aprendizado por
