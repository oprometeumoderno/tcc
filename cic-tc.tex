...
%
% Devido, entretanto, ao seu alto grau de especialidade (o MuJoCo foi feito
% especialmente para atender à demanda do ramo da robótica, onde motores de [
% simulações físicas voltados para jogos não são suficientes)



% MuJoCo (nome que deriva )
